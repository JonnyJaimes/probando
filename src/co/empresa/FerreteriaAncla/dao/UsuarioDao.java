package co.empresa.FerreteriaAncla.dao;
...
import co.empresa.FerreteriaAncla.util.Conexion;

public class UsuarioDao {

	
	private Conexion conexion;
	private static final String sql="SELECT * FROM usuario WHERE nombre=? AND pais=?";
	...
	public  Usuario validar (String user,String dni){
		...
		try {
			...
			PreparedStatement preparedStatement =conexion.setPreparedStatement(sql);
			...
			while (re.next()) {
				em.setNombre(re.getString("usuario"));
				em.setPais(re.getString("pais"));
